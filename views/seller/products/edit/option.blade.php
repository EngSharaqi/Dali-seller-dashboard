				...
				<div class="row">
					<div class="col-sm-3">
                        <ul class="nav nav-pills flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('seller.product.edit.price',$info->id) }}"><i class="fas fa-money-bill-alt"></i> {{ __('Price') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="{{ route('seller.product.edit.option',$info->id) }}"><i class="fas fa-tags"></i> {{ __('Options') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('seller.product.edit.variant',$info->id) }}"><i class="fas fa-expand-arrows-alt"></i> {{ __('Variants') }}</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('seller.product.edit.images',$info->id) }}"><i class="far fa-images"></i> {{ __('Images') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('seller.product.edit.inventory',$info->id) }}"><i class="fa fa-cubes"></i> {{ __('Inventory') }}</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('seller.product.edit.files',$info->id) }}"><i class="fas fa-file"></i> {{ __('Files') }}</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('seller.product.edit.seo',$info->id) }}"><i class="fas fa-chart-line"></i> {{ __('SEO') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('seller.product.edit.express-checkout',$info->id) }}"><i class="fas fa-cart-arrow-down"></i> {{ __('Express checkout') }}</a>
                            </li>
                        </ul>
					</div>
					<div class="col-sm-9">
...
<div class="modal fade" id="new_row_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog">
     <div class="modal-content">
        <form action="{{ route('seller.product.add_row',$info->id) }}" class="basicform_with_reload" method="post">
         @csrf
...
<div class="modal fade" id="editform" tabindex="-1" aria-labelledby="editform" aria-hidden="true">
   <div class="modal-dialog">
     <div class="modal-content">
       ...
       <form action="{{ route('seller.product.row_update',$info->id) }}" class="basicform row_update_form" >
         @csrf
       <div class="modal-body">
         <div class="form-group">
             <label for="name">{{ __('Option Name') }}</label>
...
<form class="basicform delete_from" action="{{ route('seller.product.option_delete',$info->id) }}"  method="post">
@csrf
