                                ...
                                <table class="table table-hover table-nowrap card-table text-center">
                                    ...
                                    @foreach($orders as $key => $row)
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                <a href="{{ route('seller.orders.show',$row->id) }}">{{ $row->order_no }}</a>
                                            </td>
                                            <td><a href="{{ route('seller.orders.show',$row->id) }}">{{ $row->created_at->format('d-F-Y') }}</a></td>
                                            ...
                                            <td><a href="{{ route('seller.invoice',$row->id) }}" class="btn btn-primary btn-sm" target="_blank"><i class="fas fa-print"></i></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                    <tfoot>
