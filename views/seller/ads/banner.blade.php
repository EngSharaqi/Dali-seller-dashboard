...
<div class="card">
	<div class="card-body">
		...
		<div class="float-left mb-2">
			<button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">{{ __('Edit Banner') }}</button>
		</div>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="{{ route('seller.ad.update',11) }}" class="basicform_with_reload">
					@csrf
